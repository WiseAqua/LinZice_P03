...
[CreateAssetMenu(fileName = "MonstrData_", menuName = "UnitData/Monster")]
public class MonsterData : ScriptableObject
{
    ...
    [SerializeField]
    [Tooltip("Radius where size monster will see the player")]
    ...
    public int Damage => _damage; public int Health => _health;
